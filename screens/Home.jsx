  ...
  return (
    <View className="bg-white dark:bg-gray-900 mx-4 mt-3 mb-4 p-4 rounded-2xl shadow-sm">
      ...
      <TouchableOpacity
        ...
        className="flex-row items-center justify-between py-2 border-t border-gray-200 dark:border-gray-700 pt-3"
        activeOpacity={0.7}
      >
        <Text className="text-sm font-medium text-gray-700 dark:text-gray-300">
          Search by Zip Code
        </Text>
        <Text className="text-xl text-gray-400">{showZipInput ? '−' : '+'}</Text>
      </TouchableOpacity>
        ...
        <View className="mt-3">
          <View className="flex-row items-center">
            <TextInput
              ...
              maxLength={10}
              className="flex-1 bg-gray-50 dark:bg-gray-800 text-black dark:text-white px-4 py-3 rounded-xl text-base"
            />
            <TouchableOpacity
...
export default function HomeScreen() {
  ...
  const renderLoadingState = () => (
    <View className="flex-1 items-center justify-center py-20">
      ...
      <Text className="text-gray-500 dark:text-gray-400 mt-4">Loading restaurants...</Text>
    </View>
  );
  ...
  return (
    <SafeAreaView className="flex-1 bg-gray-50 dark:bg-black">
      ...
      <FlatList
        ...
        ListEmptyComponent={isLoadingRestaurants ? renderLoadingState() : renderEmptyState()}
